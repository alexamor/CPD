...
POMP_Atomic_enter(&omp_rd_4);
#line 147 "simpar-omp.c"
				#pragma omp atomic
    		cell_mat[column][row].y += par[i].m * par[i].y;
POMP_Atomic_exit(&omp_rd_4);
#line 149 "simpar-omp.c"
POMP_Atomic_enter(&omp_rd_5);
#line 149 "simpar-omp.c"
				#pragma omp atomic
				cell_mat[column][row].x += par[i].m * par[i].x;
POMP_Atomic_exit(&omp_rd_5);
#line 151 "simpar-omp.c"

    		// total mass
POMP_Atomic_enter(&omp_rd_6);
#line 153 "simpar-omp.c"
				#pragma omp atomic
    		cell_mat[column][row].m += par[i].m;
POMP_Atomic_exit(&omp_rd_6);
#line 155 "simpar-omp.c"
...
#line 157 "simpar-omp.c"

POMP_Parallel_fork(&omp_rd_7);
#line 158 "simpar-omp.c"
			#pragma omp parallel     private(i, j)
...
#line 164 "simpar-omp.c"

    	// calculation of the gravitational force
POMP_Parallel_fork(&omp_rd_8);
#line 166 "simpar-omp.c"
#pragma omp parallel     private(i, j, k, column, row, adj_column, adj_row, dx, dy, d2, F, aux_atan)
